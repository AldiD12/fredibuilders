        ...
        <div className="border-t border-slate-800 pt-8 pb-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">Registered Address</p>
                <p className="text-sm text-gray-300">71 Lyndhurst Road</p>
                <p className="text-sm text-gray-300">Thornton Heath, Croydon</p>
                <p className="text-sm text-gray-300">CR7 7PZ</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <span className="material-icons-outlined text-primary text-lg">phone</span>
              <div>
                <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">Phone</p>
                <a href="tel:+447468451511" className="text-sm text-gray-300 hover:text-primary transition-colors">
                  +44 7468 451511
                </a>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <span className="material-icons-outlined text-primary text-lg">email</span>
              <div>
                <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">Email</p>
                <a href="mailto:fredibuilder18@icloud.com" className="text-sm text-gray-300 hover:text-primary transition-colors">
        ...
        <div className="border-t border-slate-800 pt-8 pb-6">
          <div className="text-center mb-4">
            ...
            <div className="flex justify-center gap-4">
              <a 
                href="https://www.facebook.com/fredibuilders" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 bg-primary/10 hover:bg-primary rounded-full flex items-center justify-center transition-colors group"
                aria-label="Follow us on Facebook"
              >
                <svg className="w-5 h-5 text-primary group-hover:text-gray-900" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a 
                href="https://www.instagram.com/fredibuilders" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 bg-primary/10 hover:bg-primary rounded-full flex items-center justify-center transition-colors group"
              ...
              <a 
                href="https://www.linkedin.com/company/fredibuilders" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 bg-primary/10 hover:bg-primary rounded-full flex items-center justify-center transition-colors group"
